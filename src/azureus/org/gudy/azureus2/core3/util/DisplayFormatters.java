...
DisplayFormatters
{
  ...
  setUnits()
  {
	...
	public static void
	loadMessages(java.util.Map<String, String> map)
	{
	    PeerManager_status_finished     = map.get( "PeerManager.status.finished");
        PeerManager_status_finishedin   = map.get( "PeerManager.status.finishedin");
        Formats_units_alot              = map.get( "Formats.units.alot");
        discarded                       = map.get( "discarded");
        ManagerItem_waiting             = map.get( "ManagerItem.waiting");
        ManagerItem_initializing        = map.get( "ManagerItem.initializing");
        ManagerItem_allocating          = map.get( "ManagerItem.allocating");
        ManagerItem_checking            = map.get( "ManagerItem.checking");
        ManagerItem_finishing           = map.get( "ManagerItem.finishing");
        ManagerItem_ready               = map.get( "ManagerItem.ready");
        ManagerItem_downloading         = map.get( "ManagerItem.downloading");
        ManagerItem_seeding             = map.get( "ManagerItem.seeding");
        ManagerItem_superseeding        = map.get( "ManagerItem.superseeding");
        ManagerItem_stopping            = map.get( "ManagerItem.stopping");
        ManagerItem_stopped             = map.get( "ManagerItem.stopped");
        ManagerItem_paused              = map.get( "ManagerItem.paused");
        ManagerItem_queued              = map.get( "ManagerItem.queued");
        ManagerItem_error               = map.get( "ManagerItem.error");
        ManagerItem_forced              = map.get( "ManagerItem.forced");
        yes                             = map.get( "GeneralView.yes");
        no                              = map.get( "GeneralView.no");
	}
