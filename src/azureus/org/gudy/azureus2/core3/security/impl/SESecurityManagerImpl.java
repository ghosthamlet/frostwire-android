...
SESecurityManagerImpl 
{
	...
	installSecurityManager()
	{
		...
		String	prop = System.getProperty( "azureus.security.manager.install", "0" );
	...
	createSelfSignedCertificate(
		...
		throws Exception
	{
		return null;//( SESecurityManagerBC.createSelfSignedCertificate( this, alias, cert_dn, strength ));
	}
