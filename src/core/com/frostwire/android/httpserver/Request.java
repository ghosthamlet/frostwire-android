...
public class Request {
        ...
        while (firstc != LF && firstc != CR && firstc >= 0) {
            ...
            parseloop: {
                while ((c = is.read()) >= 0) {
                    ...
                    case '\t':
                        c = ' ';
                        inKey = false; //WARNING: Added this since Xlint was complaining
                        break; //that this 'break' wasn't here.
                    case ' ':
                        inKey = false;
                        break;
                    case CR:
    ...
    static class ReadStream extends InputStream {
        ...
        public ReadStream(HttpServer server, SocketChannel chan) throws IOException {
            this.channel = chan;
            this.server = server;
    ...
    static class WriteStream extends java.io.OutputStream {
        ...
        public WriteStream(HttpServer server, SocketChannel channel) throws IOException {
