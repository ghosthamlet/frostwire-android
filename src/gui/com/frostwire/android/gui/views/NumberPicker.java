...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mStart = a.getInt( R.styleable.numberpicker_picker_startRange, DEFAULT_MIN );
        mEnd = a.getInt( R.styleable.numberpicker_picker_endRange, DEFAULT_MAX );
        mWrap = a.getBoolean( R.styleable.numberpicker_picker_wrap, DEFAULT_WRAP );
        mCurrent =  a.getInt( R.styleable.numberpicker_picker_defaultValue, DEFAULT_VALUE );
